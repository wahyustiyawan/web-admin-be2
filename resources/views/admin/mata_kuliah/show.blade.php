            ...
            <div class="card-body">
              <form role="form text-left" action="{{route('storePertemuan')}}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="tugas_mandiri " placeholder="Masukkan link materi tugas mandiri" aria-label="Name" aria-describedby="email-addon" required>
                </div>
                <div class="mb-3">
