      ...
      <div class="card-header pb-0 p-3">
        <div class="row">
          ...
          <div class="col-6 text-end">
            <a class="btn bg-gradient-dark mb-0" href="{{route('akseskelasDosen.create')}}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
          </div>
        </div>
      </div>
            ...
            <tr>
              ...
              <td>
                <div class="ms-auto text-center">
                  <form action="{{route('destroyAksesKelasDosen', $item->id)}}" method="POST" style="display: inline">
                    @csrf
                    @method("DELETE")
                  ...
                  <a class="btn btn-link text-dark px-3 mb-0" href="{{route('editAksesKelasDosen', $item->id)}}"><i class="fas fa-user-edit text-secondary"></i></a>
